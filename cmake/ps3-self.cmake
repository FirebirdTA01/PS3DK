...
if(NOT _PS3_SPU_TOOLS_PROBED)
    ...
    # Normal JOBBIN_WRAP builds use the clean-room spu-elf-to-ppu-obj tool.
...
function(ps3_add_spu_image target)
    ...
    # and a byte-correct CellSpursJobHeader template.  The clean-room
    ...
    if(_PSI_JOBBIN_WRAP)
        ...
        if(NOT CMAKE_HOST_WIN32 AND _ps3_jobbin2_use_reference_helper AND NOT PS3_TOOL_ppu_lv2_gcc_dir)
            message(FATAL_ERROR "ps3_add_spu_image: reference-helper JOBBIN_WRAP needs ppu-lv2-gcc.exe dir on wine PATH (set PS3_PPU_LV2_GCC_BIN_DIR env or place at ~/cell-sdk/3.70-extract/toolchain/cell/host-win32/ppu/bin/)")
        endif()
