 ...
 *
 * reference-SDK-style spellings of the libgcm constants our PSL1GHT runtime
 * layer exposes under plain `GCM_` names.  Adds the `CELL_GCM_`
 * prefix so the reference SDK-authored sample code compiles unchanged; numerics
...
#define CELL_GCM_COLOR_MASK_MRT1_A       GCM_COLOR_MASK_MRT1_A
#define CELL_GCM_COLOR_MASK_MRT1_R       GCM_COLOR_MASK_MRT1_R
#define CELL_GCM_COLOR_MASK_MRT1_G       GCM_COLOR_MASK_MRT1_G
#define CELL_GCM_COLOR_MASK_MRT1_B       GCM_COLOR_MASK_MRT1_B
#define CELL_GCM_COLOR_MASK_MRT2_A       GCM_COLOR_MASK_MRT2_A
#define CELL_GCM_COLOR_MASK_MRT2_R       GCM_COLOR_MASK_MRT2_R
#define CELL_GCM_COLOR_MASK_MRT2_G       GCM_COLOR_MASK_MRT2_G
#define CELL_GCM_COLOR_MASK_MRT2_B       GCM_COLOR_MASK_MRT2_B
#define CELL_GCM_COLOR_MASK_MRT3_A       GCM_COLOR_MASK_MRT3_A
#define CELL_GCM_COLOR_MASK_MRT3_R       GCM_COLOR_MASK_MRT3_R
#define CELL_GCM_COLOR_MASK_MRT3_G       GCM_COLOR_MASK_MRT3_G
#define CELL_GCM_COLOR_MASK_MRT3_B       GCM_COLOR_MASK_MRT3_B

/* Maximum simultaneous color render targets. */
#define CELL_GCM_MRT_MAXCOUNT            GCM_MAX_MRT_COUNT
...
/* Additional the reference SDK-named vertex-data types verified against the
 * reference the reference SDK's gcm_enum.h.  PSL1GHT only aliased F32=2 and
...
/* Long-form aliases matching the reference the reference SDK's alt names. */
...
/* libgcm error codes (the reference SDK numbering — out-of-band from
 ...
 * (non-CELL-prefixed) namespace so the reference SDK source that references
...
/* Fragment-program ucode placement alignment.  reference-SDK samples align
...
#define CELL_GCM_COMPMODE_C32_2X1               GCM_COMPMODE_C32_2X1
...
#define CELL_GCM_DECR_WRAP                       GCM_DECR_WRAP
...
#define CELL_GCM_SCULL_SFUNC_NOTEQUAL            GCM_SCULL_SFUNC_NOTEQUAL

/* Transfer engine. */
#define CELL_GCM_TRANSFER_LOCAL_TO_LOCAL          GCM_TRANSFER_LOCAL_TO_LOCAL
#define CELL_GCM_TRANSFER_MAIN_TO_LOCAL           GCM_TRANSFER_MAIN_TO_LOCAL
#define CELL_GCM_TRANSFER_LOCAL_TO_MAIN           GCM_TRANSFER_LOCAL_TO_MAIN
#define CELL_GCM_TRANSFER_MAIN_TO_MAIN            GCM_TRANSFER_MAIN_TO_MAIN
#define CELL_GCM_TRANSFER_SURFACE                 GCM_TRANSFER_SURFACE
#define CELL_GCM_TRANSFER_SWIZZLE                 GCM_TRANSFER_SWIZZLE
#define CELL_GCM_TRANSFER_CONVERSION_DITHER       GCM_TRANSFER_CONVERSION_DITHER
#define CELL_GCM_TRANSFER_CONVERSION_TRUNCATE     GCM_TRANSFER_CONVERSION_TRUNCATE
#define CELL_GCM_TRANSFER_CONVERSION_SUBTRACT_TRUNCATE GCM_TRANSFER_CONVERSION_SUBTRACT_TRUNCATE
#define CELL_GCM_TRANSFER_SCALE_FORMAT_A1R5G5B5   GCM_TRANSFER_SCALE_FORMAT_A1R5G5B5
#define CELL_GCM_TRANSFER_SCALE_FORMAT_X1R5G5B5   GCM_TRANSFER_SCALE_FORMAT_X1R5G5B5
#define CELL_GCM_TRANSFER_SCALE_FORMAT_A8R8G8B8   GCM_TRANSFER_SCALE_FORMAT_A8R8G8B8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_X8R8G8B8   GCM_TRANSFER_SCALE_FORMAT_X8R8G8B8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_CR8YB8CB8YA8 GCM_TRANSFER_SCALE_FORMAT_CR8YB8CB8YA8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_YB8CR8YA8CB8 GCM_TRANSFER_SCALE_FORMAT_YB8CR8YA8CB8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_R5G6B5     GCM_TRANSFER_SCALE_FORMAT_R5G6B5
#define CELL_GCM_TRANSFER_SCALE_FORMAT_Y8         GCM_TRANSFER_SCALE_FORMAT_Y8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_AY8        GCM_TRANSFER_SCALE_FORMAT_AY8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_EYB8ECR8EYA8ECB8 GCM_TRANSFER_SCALE_FORMAT_EYB8ECR8EYA8ECB8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_ECR8EYB8ECB8EYA8 GCM_TRANSFER_SCALE_FORMAT_ECR8EYB8ECB8EYA8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_A8B8G8R8   GCM_TRANSFER_SCALE_FORMAT_A8B8G8R8
#define CELL_GCM_TRANSFER_SCALE_FORMAT_X8B8G8R8   GCM_TRANSFER_SCALE_FORMAT_X8B8G8R8
#define CELL_GCM_TRANSFER_OPERATION_SRCCOPY_AND   GCM_TRANSFER_OPERATION_SRCCOPY_AND
#define CELL_GCM_TRANSFER_OPERATION_ROP_AND       GCM_TRANSFER_OPERATION_ROP_AND
#define CELL_GCM_TRANSFER_OPERATION_BLEND_AND     GCM_TRANSFER_OPERATION_BLEND_AND
#define CELL_GCM_TRANSFER_OPERATION_SRCCOPY       GCM_TRANSFER_OPERATION_SRCCOPY
#define CELL_GCM_TRANSFER_OPERATION_SRCCOPY_PREMULT GCM_TRANSFER_OPERATION_SRCCOPY_PREMULT
#define CELL_GCM_TRANSFER_OPERATION_BLEND_PREMULT GCM_TRANSFER_OPERATION_BLEND_PREMULT
#define CELL_GCM_TRANSFER_ORIGIN_CENTER           GCM_TRANSFER_ORIGIN_CENTER
#define CELL_GCM_TRANSFER_ORIGIN_CORNER           GCM_TRANSFER_ORIGIN_CORNER
#define CELL_GCM_TRANSFER_INTERPOLATOR_NEAREST    GCM_TRANSFER_INTERPOLATOR_NEAREST
#define CELL_GCM_TRANSFER_INTERPOLATOR_LINEAR     GCM_TRANSFER_INTERPOLATOR_LINEAR
#define CELL_GCM_TRANSFER_INTERPOLATOR_FOH        GCM_TRANSFER_INTERPOLATOR_LINEAR
#define CELL_GCM_TRANSFER_SURFACE_FORMAT_R5G6B5   GCM_TRANSFER_SURFACE_FORMAT_R5G6B5
#define CELL_GCM_TRANSFER_SURFACE_FORMAT_A8R8G8B8 GCM_TRANSFER_SURFACE_FORMAT_A8R8G8B8
#define CELL_GCM_TRANSFER_SURFACE_FORMAT_Y32      GCM_TRANSFER_SURFACE_FORMAT_Y32
