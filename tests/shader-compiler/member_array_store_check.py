...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='member-array-',dir=root) as tmp:
        ...
        assert len(review_rows)==17,'review row lost'
    ...
    print(f'PASS ({twins} strict twins, {refusals} named array-store refusals/gaps, 6 output record/value rows, 17 copy/alias/semantic controls)')
