#ifndef PS3DK_PSGL_DEPRECATED_ALIASES_H
#define PS3DK_PSGL_DEPRECATED_ALIASES_H
...
/* Some legacy aliases name surfaces that land in later compatibility slices. */
...
#endif /* PS3DK_PSGL_DEPRECATED_ALIASES_H */
