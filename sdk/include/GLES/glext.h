#ifndef PS3DK_GLES_GLEXT_H
#define PS3DK_GLES_GLEXT_H
...
#define GL_ALPHA_LUMINANCE_SCE 0x600A
...
GLAPI void glBlendColor(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
...
GLAPI void glDrawRangeElements(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices);
...
GLAPI void glTexImage3D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
...
GLAPI void glTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels);
...
GLAPI void glBufferData(GLenum target, GLsizeiptr size, const GLvoid *data, GLenum usage);
GLAPI void glBufferSubData(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid *data);
...
GLAPI void glPrimitiveRestartIndexNV(GLuint index);
...
GLAPI void glFinishFenceNV(GLuint fence);
...
GLAPI void glSetEventSCE(GLuint event);
GLAPI void glResetEventSCE(GLuint event);
...
GLAPI void glRenderbufferStorageOES(GLenum target, GLenum internalformat, GLsizei width, GLsizei height);
GLAPI void glGetRenderbufferParameterivOES(GLenum target, GLenum pname, GLint *params);
...
GLAPI void glFramebufferTexture2DOES(GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);
GLAPI void glFramebufferRenderbufferOES(GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer);
GLAPI void glGetFramebufferAttachmentParameterivOES(GLenum target, GLenum attachment, GLenum pname, GLint *params);
GLAPI void glGenerateMipmapOES(GLenum target);
GLAPI void glFramebufferParameteriSCE(GLenum target, GLenum pname, GLint param);
...
GLAPI void glEndQueryARB(GLenum target);
...
GLAPI void glGetQueryObjectul64vARB(GLuint id, GLenum pname, unsigned long long *params);
GLAPI void glBeginConditionalRenderingSCE(GLuint id);
GLAPI void glEndConditionalRenderingSCE(void);
GLAPI void glActiveStencilFaceEXT(GLenum face);
...
GLAPI void glBindAttribSetSCE(GLuint name);
GLAPI void glCopyAttribSetSCE(GLuint fromName, GLuint toName);
GLAPI void glPushStringMarkerSCE(const GLubyte *string);
