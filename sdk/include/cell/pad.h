 ...
 *
 * reference-SDK-style pad / controller input surface in our SDK's cell/
 ...
 * presents the the reference SDK-spelled API on top.  As the SDK is weaned
...
/* ---- structs with the reference SDK field names ----------------------------- */
/*
 ...
 * checking still catches mistakes at the the reference SDK-named boundary.  GCC
 ...
 * words; its layout matches what the reference SDK callers expect through
