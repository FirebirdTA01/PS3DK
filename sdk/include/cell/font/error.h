/*
 * PS3 Custom Toolchain - cell/font/error.h
 *
 * CELL_FONT_ERROR_* return codes for the cellFont / cellFontFT
 * library surface.
 */
#ifndef _PS3DK_CELL_FONT_ERROR_H_
#define _PS3DK_CELL_FONT_ERROR_H_
