/*! \file cell/gcm/gcm_command_c.h
 \brief the reference SDK-source-compat libgcm command-emitter forwarders.
  ...
  the reference SDK command-emitter family is generated by macro from
...
/* Note the reference SDK spelling: BackEnd (capital E) vs PSL1GHT's Backend. */
 ...
 * cellGcmSet* signatures here preserve the reference SDK ABI/source-compat.
 * ========================================================== */
 ...
 * (index * 0x10).  Arg encoding per the reference the reference SDK's
...
/* ==========================================================
 * Generic enum-typed POD (used by the reference SDK source where the
