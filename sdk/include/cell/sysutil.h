/*! \file cell/sysutil.h
 \brief Sony-named forwarder over PSL1GHT's <sysutil/sysutil.h>.
  ...
  written against the the reference SDK compiles against PSL1GHT's runtime with
 ...
 * are identical across the rename; code paraphrased from the reference SDK
 * the reference SDK sysutil_common.h.  RPCS3 fires (at minimum)
