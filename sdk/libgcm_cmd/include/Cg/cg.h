 ...
 * that the reference compiler writes into CgBinaryProgram / CgBinaryParameter fields.
...
enum
{
    ...
    /* Handle / object types */
    CG_STRING            = 1134,
    CG_PROGRAM_TYPE      = 1135,
    CG_TEXTURE           = 1136,
    CG_SAMPLER1DARRAY    = 1137,
    CG_SAMPLER2DARRAY    = 1138,
    CG_SAMPLERCUBEARRAY  = 1139,
