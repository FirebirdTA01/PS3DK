#!/usr/bin/env bash
# PS3 Custom Toolchain - stub-only the reference SDK libraries
#
...
STUB_YAMLS=(
    ...
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libnetctl_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libnet_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libssl_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libhttp_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libhttp_util_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_np_util_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_np_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_np_trophy_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_np_sns_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_np_clans_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_np_commerce2_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_np_tus_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_np2_stub.yaml"
    ...
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libcamera_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libresc_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libovis_stub.yaml"
    ...
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libfont_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libfontFT_stub.yaml"
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libkey2char_stub.yaml"
    ...
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/libsysutil_game_exec_stub.yaml"
    ...
    "$PS3_TOOLCHAIN_ROOT/tools/nidgen/nids/extracted/liblv2dbg_stub.yaml"
