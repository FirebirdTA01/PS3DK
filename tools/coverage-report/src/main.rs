//! coverage-report — the reference SDK vs our install tree API coverage.
//!
...
#[derive(Parser)]
#[command(name = "coverage-report", about = "the reference SDK vs our install tree coverage matrix")]
struct Cli {
...
fn render_report(
    ...
    writeln!(
        out,
        "Sony reference SDK the reference SDK symbols vs our install tree.  Primary diff \
