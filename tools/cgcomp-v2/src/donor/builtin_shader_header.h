// Built-in Vita CG header (editable source).
// This file is the authoritative version that is automatically
// embedded into the compiler binary at build time.
// This header is included by the compiler before compiling any user shader.

/*
 *  Fast Blend Intrinsics
 */

// BLEND_OP_X for fastblend intrinsic
#define __BLEND_OP_ADD 1
#define __BLEND_OP_SUB 2
#define __BLEND_OP_MIN 3
#define __BLEND_OP_MAX 4

// BLEND_FACTOR_X for fastblend intrinsic
...
// BLEND_WMASK_X for fastblend intrinsic
...
// (End of embedded built-in header)
