...
The binary is named `rsx-cg-compiler` to mirror Sony's own the reference compiler
...
- Stage 2: NV40 back-end emits ucode bit-identical to Sony the reference compiler for
