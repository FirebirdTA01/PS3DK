...
| `hello-ppu-sysutil-cb/` | Sony-named `cellSysutilRegisterCallback`/`Check`/`Unregister` through PSL1GHT runtime — first Phase 6 backfill sample, imports Sony FNIDs 0x9d98afa0/0x189a74da/0x02ff3c1b | Phase 3 + patch psl1ght/0011 | **green** (RPCS3 runtime test pending) |
